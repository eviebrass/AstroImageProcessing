...
#randomising the radi 

#creating gaussian object 
for i in range(n_objects): # same as i value
    obj_n = gauss_2d(size_m,loc_ran[0][i],loc_ran[1][i],1,1000)
